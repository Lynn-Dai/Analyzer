...
def list_to_csv(data):
    ...
    writerCSV.to_csv('./conf_meths/honor-t-meths.csv', encoding='utf-8')


if __name__ == '__main__':
    ast_csv = "E:/PycharmProjects/DataExtraction/CustomizedAndroid/history/android_base/ast/honor/honor_t_trunk_magicui-merge.csv"
